...
//       const blob = new Blob([response.data], { type: 'application/vnd.ms-outlook' });
//       const url = window.URL.createObjectURL(blob);
//       const a = document.createElement('a');
//       a.href = url;
//       a.download = "Session_Email.msg";
...
//           multiple
//           required
//           onChange={(e) => handleFileChange(e, "qna")}
//         /><br />
//         <label>Transcript VTT:</label>
//         <input
//           type="file"
...
//           multiple
//           required
//           onChange={(e) => handleFileChange(e, "feedback")}
//         /><br /><br />
